...
def test_tensor_div_zero():
    ...
    t1 = Tensor(np.array([[1.0, 2.0], [3.0, 4.0]]), np.float32, True, (2, 2))
...
def test_tensor_matmul():
    ...
    t1 = Tensor(np_data1, np.float32, True, (2, 2))
    t2 = Tensor(np_data2, np.float32, True, (2, 2))
    result_t = t1 @ t2
...
def test_tensor_matmul_shape_mismatch():
    ...
    t1 = Tensor(np.random.randn(2, 3), np.float32, False, (2, 3))
    t2 = Tensor(np.random.randn(4, 2), np.float32, False, (4, 2))
...
def test_tensor_matmul_3d_not_supported():
    ...
    t1 = Tensor(np.random.randn(2, 3, 4), np.float32, False, (2, 3, 4))
    t2 = Tensor(np.random.randn(2, 4, 5), np.float32, False, (2, 4, 5))
...
def test_tensor_tensor_multiplication_not_supported():
    ...
    t1 = Tensor(np.array([[1.0, 2.0], [3.0, 4.0]]), np.float32, False, (2, 2))
    t2 = Tensor(np.array([[0.5, 1.0], [1.5, 2.0]]), np.float32, False, (2, 2))
